...
const jokesApiUrl = 'https://sv443.net/jokeapi/v2/joke/Any?blacklistFlags=nsfw,religious,political,racist,sexist';
...
function tellJoke(joke) {
    VoiceRSS.speech({
        key: '2325bb2150e840b4803780e1e6a133f2',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
    try{
        ...
        let joke = '';
        if(jokesData.setup){
            joke = `${jokesData.setup} .. ${jokesData.delivery}`
        }else{
            joke = jokesData.joke;
        }
        toggleButton();
